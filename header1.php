...
<body>
    ...
    <div class="col-12 ">
        <header>
            <div class="row  p-3 p-lg-0  fixed-top " style="background-color: rgb(255, 255, 255);">
                ...
                <div class="col-2 text-center">
                    ...
                    <nav class="navbar navbar-expand-lg  pt-3 na">
                        <div class="container-fluid p-0">
                            <a class="navbar-brand text-decoration-none activea a d-lg-none mt-1 ms-5" href="#">Menu</a>
                            ...
                            <div class="collapse navbar-collapse   " id="navbarNavDropdown">
                                <ul class="navbar-nav">
                                    <li class="nav-item pt-1 pt-lg-3 pb-lg-3 pe-lg-3 ms-3 ms-lg-0">
                                        <a class="text-decoration-none active a" aria-current="page" href="home.php">Home</a>
                                    </li>
                                    <li class="nav-item  pt-1 p-lg-3 ms-3 ms-lg-0">
                                        <a class="text-decoration-none   a" href="adminPanle.php">All Product</a>
                                    </li>
                                    ...
                                    <li class="nav-item dropdown pt-1  pt-lg-3 pb-lg-3 ps-lg-3 ms-3 ms-lg-0">
                                        <a class="text-decoration-none activea ab dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            link
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="./adminPanle.php">Action</a></li>
