...
?>
    ...
    <div class="col-11 p-1 d-flex justify-content-center disdivbuy" style="border-radius: 2px; cursor: pointer;" onclick="selectdistricbuy('<?php echo($distric_data['distric_name']) ?>');">
