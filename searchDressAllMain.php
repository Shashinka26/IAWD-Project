...
// $jsonToobj2=json_decode($jsonshort);
session_start();
...
$query = "SELECT dress.id,dress.Dress_code,dress.price,dress.qty,dress.add_date_time,dress.delivery_fee,dress.admin_email,dress.Stutus,dress.Delevery_fee_Westen,dress.materiale_id,dress.Model_size_id,
dress_has_dress_sizes.Dress_id,dress_has_dress_sizes.dress_sizes_id,dress_has_dress_sizes.Dressqty, dress_has_dress_sizes.id AS dhs  FROM `dress`";
...
if ($id == "1") {
    ...
    $query .= " INNER JOIN `dress_has_dress_sizes` ON  dress_has_dress_sizes.Dress_id=dress.id  WHERE  dress_has_dress_sizes.dress_sizes_id='" . $id . "' ORDER BY `add_date_time` DESC";
                ...
                <div class="row justify-content-center">
                    ...
                    if ($Dress_num > 0) {
                        ...
                        for ($x = 0; $x < $Dress_num; $x++) {
                            ...
                            $product_data = $results_rs->fetch_assoc();
