...
if ($id == "s3") {
    ...
    $query .= " INNER JOIN `wichlist` ON  wichlist.Dress_id=dress.id WHERE `Stutus`='1'  GROUP BY `Dress_id` HAVING COUNT(`Dress_id`)>0 ORDER BY COUNT(`Dress_id`) DESC";
                                    ...
                                    <div class="col-12" >
                                        <div class="row">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <div class="col-2" id="wichlistaddDiv"> <i class="bi bi-heart fs-4 wich" style=" cursor: pointer;" onclick="addWichlist('<?php echo ($product_data['id']) ?>_<?php echo ($email) ?>_<?php echo ($product_data['Dress_code']) ?>');"></i></div>
                                                <?php
                                                }
                                            } else {
                                                ?>
...
<img src="images/icon/cash on delivery.png" class=""  style="width: 20rem; height: 30rem;" alt="">
                            ...
                            <div class=" ms-md-2 me-md-2 ms-0 mb-0  mt-3   overflow-hidden  p-0 product  d-md-none d-lg-none opacity-75" style="width: 12.2rem; height: 29rem;">
                                ...
                                ?>
                                <div class="mt-3 pt-1" style="position: absolute; width: 12.2rem; height: 19rem;">
                                    <div class="col-12 mt-5 pt-5">
                                        <div class="row">
                                            <div class="col-2">
                                                <hr class="bg-black p-0 fs-2" style="height: 2px;">
