...
(function($, global) {
    ...
    $.extend(sergelandimagezoomer, {
        ...
        dsetting: { //default settings
            ...
            // cursorshadeborder: '0px solid black', // внешний бордюра контейнера лупы в формате CSS
            zindex: '', // z-index контейнера лупы 
            stepzoom: 0.5, // шаг зуммирования при прокрутке колеса мыши					
            zoomrange: [2, 2], // диапазон зуммирования
            zoomstart: 1.6, // стартовая установка зуммирования
            ...
            // // showstatustime: 10000, // время показа help контейнера
            ...
            // magnifierpos: 'left', // сторона отображения контейнера left/right
            ...
            // scrollspeedanimate: 1 /*4*/ , // прокрутки big картинки
            // zoomspeedanimate: 20, // зуммирования (плавность)
        ...
        init: function($img, options, gallery) {
            ...
            $magnifier = $("<div />")
                ...
                .css({
                    ...
                    height: setting.magnifiersize[0],
                    left: -100,
                    top: -100,
                    visibility: "hidden",
                    overflow: "hidden",
